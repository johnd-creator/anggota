...
const closeButtonClasses = computed(() => {
  ...
  const variants = {
    info: 'text-status-info-dark hover:bg-status-info focus:ring-status-info',
    success: 'text-status-success-dark hover:bg-status-success focus:ring-status-success',
    warning: 'text-status-warning-dark hover:bg-status-warning focus:ring-status-warning',
    error: 'text-status-error-dark hover:bg-status-error focus:ring-status-error',
  };
