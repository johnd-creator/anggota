    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 relative">
      <div class="w-full max-w-md space-y-8">
        ...
        <div>
          ...
          <a href="/auth/microsoft" class="mt-3 flex items-center justify-center gap-3 w-full px-4 py-2.5 border border-neutral-200 rounded-xl bg-white hover:bg-neutral-50 hover:border-neutral-300 transition-all duration-200 shadow-sm group relative" title="Hanya untuk email @plnipservices.co.id">
